...
function cmd(){
    ...
    }   else if (my_user_input.value == "help") {
        br();

        //clear, help, leyfetch, projects
        cons_valuebr(" ");
        cons_valuebr("welcome to my portfolio!");
        cons_valuebr("----------------------------------");
        cons_valuebr("these are the commands you can use");
        cons_valuebr("----------------------------------");
        cons_valuebr("help                 lists all the commands you can use.");
        cons_valuebr("leyfetch             fetches my social media profiles.");
        cons_valuebr("clear                clears the terminal.");
        cons_valuebr("projects             shows you the projects i have worked on.");
        cons_valuebr("restart              refreshes the website for a new start.");

        my_user_input.value = "";
        br();

        
    }   else if (my_user_input.value == "leyfetch") {
    ...
    }   else if (my_user_input.value == "restart") {
        location.reload();
    } else if (my_user_input.value == "projects"){
        br();
        cons_value("redirecting..")
...
function loop() {
    ...
    if (my_user_input.value == "help" || my_user_input.value == "projects" || my_user_input.value == "leyfetch" || my_user_input.value == "clear" || my_user_input.value == "" || my_user_input.value == "restart") {
